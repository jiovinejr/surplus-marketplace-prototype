      ...
      <div>
        ...
        <div className="bg-gray-700 rounded-lg p-5 mb-4">
          ...
          <p className="text-4xl font-bold text-green-400">
            ${listing.price} <span className="text-lg">/ {listing.priceUnit}</span>
          </p>
        ...
        <div className="bg-gray-700 rounded-lg p-5 mb-4">
          ...
          <div className="space-y-3 text-sm">
            ...
            <div>
              ...
              <p className="text-white">{listing.packing}</p>
            </div>
            <div>
            ...
            {listing.supplierNotes && (
              <div>
                <span className="text-gray-400">Supplier Notes</span>
                <p className="text-white italic">"{listing.supplierNotes}"</p>
              </div>
            )}
          </div>
        </div>
